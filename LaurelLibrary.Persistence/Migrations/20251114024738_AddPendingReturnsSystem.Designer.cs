...
namespace LaurelLibrary.Persistence.Migrations
{
    ...
    [Migration("20251114024738_AddPendingReturnsSystem")]
    partial class AddPendingReturnsSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.Book", b =>
                {
                    ...
                    b.Property<string>("ClassificationReasoning")
                        .IsRequired()
                        .HasMaxLength(1024)
                    ...
                    b.Property<string>("IsbnBarcodeImagePath")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.ImportHistory", b =>
                {
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.Kiosk", b =>
                {
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.Library", b =>
                {
                    ...
                    b.Property<int>("CheckoutDurationDays")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PlanningCenterApplicationId")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");

                    b.Property<string>("PlanningCenterSecret")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.PendingReturn", b =>
                {
                    b.Property<int>("PendingReturnId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PendingReturnId"));
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.PendingReturnItem", b =>
                {
                    b.Property<int>("PendingReturnItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PendingReturnItemId"));
                    ...
                    b.HasKey("PendingReturnItemId");

                    b.HasIndex("BookInstanceId");

                    b.HasIndex("PendingReturnId");

                    b.ToTable("PendingReturnItems");
                });
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.ReaderAction", b =>
                {
                    b.Property<int>("ReaderActionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReaderActionId"));
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.HasOne("LaurelLibrary.Domain.Entities.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.BookInstance", b =>
                {
                    ...
                    b.HasOne("LaurelLibrary.Domain.Entities.Reader", "Reader")
                        .WithMany()
            ...
            modelBuilder.Entity("LaurelLibrary.Domain.Entities.PendingReturnItem", b =>
                {
                    b.HasOne("LaurelLibrary.Domain.Entities.BookInstance", "BookInstance")
                        .WithMany()
                        .HasForeignKey("BookInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LaurelLibrary.Domain.Entities.PendingReturn", "PendingReturn")
                        .WithMany("Items")
                        .HasForeignKey("PendingReturnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BookInstance");

                    b.Navigation("PendingReturn");
                });
